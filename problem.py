...
class DatabaseConnector:
    ...
    def populate(self, spreadsheet_folder):
        ...
        with open(f"{spreadsheet_folder}/spreadsheet_0.csv", "r") as spreadsheet_file_0:
            with open(f"{spreadsheet_folder}/spreadsheet_1.csv", "r") as spreadsheet_file_1:
                with open(f"{spreadsheet_folder}/spreadsheet_2.csv", "r") as spreadsheet_file_2:
